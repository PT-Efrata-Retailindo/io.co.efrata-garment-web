...
namespace Manufactures.Tests.ViewModels.GarmentDeliveryReturns
{
    public class CreateViewModelMapperTest
    {
        ...
        {
            Guid id = Guid.NewGuid();
            GarmentDeliveryReturnItemDto dto = new GarmentDeliveryReturnItemDto(new GarmentDeliveryReturnItem(id,id,1,1,"preparingItemId",new ProductId(1),"productCode", "productName","designColor","roNo",1,new UomId(1),"uomUnit","colour","rack","level","box","area"));
            CreateViewModelMapper viewModelMapper = new CreateViewModelMapper();
