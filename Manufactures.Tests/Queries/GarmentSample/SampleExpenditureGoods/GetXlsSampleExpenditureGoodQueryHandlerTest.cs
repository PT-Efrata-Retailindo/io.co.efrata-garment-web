...
{
    public class GetXlsSampleExpenditureGoodQueryHandlerTest : BaseCommandUnitTest
    {
        ...
        public GetXlsSampleExpenditureGoodQueryHandlerTest()
        {
        ...
        private GetXlsSampleExpenditureGoodQueryHandler CreateGetMonitoringExpenditureGoodQueryHandler()
        {
            return new GetXlsSampleExpenditureGoodQueryHandler(_MockStorage.Object, serviceProviderMock.Object);
        }
        ...
        {
            // Arrange
            GetXlsSampleExpenditureGoodQueryHandler unitUnderTest = CreateGetMonitoringExpenditureGoodQueryHandler();
            ...
            GetXlsSampleExpenditureGoodQuery getMonitoring = new GetXlsSampleExpenditureGoodQuery(1, 25, "{}", 1, DateTime.Now, DateTime.Now.AddDays(2),"", "token");
