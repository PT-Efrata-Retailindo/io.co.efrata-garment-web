...
{
    public class GarmentSampleCuttingOutDtoTest
    {
        [Fact]
        public void should_Success_Instantiate()
        {
            Guid id = Guid.NewGuid();
            var dto = new GarmentSampleCuttingOutDto(new GarmentSampleCuttingOut(id, "a", "a", new Domain.Shared.ValueObjects.UnitDepartmentId(1),
