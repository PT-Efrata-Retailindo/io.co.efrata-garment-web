...
{
    public class GarmentSampleCuttingInDetailDtoTest
    {
        [Fact]
        public void should_Success_Instantiate()
        {
            var id = Guid.NewGuid();
            GarmentSampleCuttingInDetailDto dto = new GarmentSampleCuttingInDetailDto(new GarmentSampleCuttingInDetail(new GarmentSampleCuttingInDetailReadModel(id)));
