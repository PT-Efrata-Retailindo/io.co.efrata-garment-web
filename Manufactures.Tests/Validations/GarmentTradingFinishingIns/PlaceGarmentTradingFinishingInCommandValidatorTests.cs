...
{
    public class PlaceGarmentTradingFinishingInCommandValidatorTests : BaseValidatorUnitTest
    {
        private readonly Mock<IGarmentFinishingInRepository> _mockGarmentFinishingInRepository;

        public PlaceGarmentTradingFinishingInCommandValidatorTests()
        {
        ...
        private PlaceGarmentTradingFinishingInCommandValidator GetValidationRules()
        {
            return new PlaceGarmentTradingFinishingInCommandValidator(_MockStorage.Object);
        }
        ...
        {
            // Arrange
            var unitUnderTest = new PlaceGarmentTradingFinishingInCommand();
        ...
        public void Place_NotHaveError()
        {
            ...
            unitUnderTest.Items = new List<GarmentTradingFinishingInItemValueObject>
            {
