...
{
    public class PlaceGarmentSampleCuttingInCommandValidatorTest
    {
        private PlaceGarmentSampleCuttingInCommandValidator GetValidationRules()
        {
            return new PlaceGarmentSampleCuttingInCommandValidator();
        }
        ...
        public void Place_HaveError()
        {
            ...
            var unitUnderTest = new PlaceGarmentSampleCuttingInCommand();
