...
{
   public class PlaceGarmentExpenditureGoodCommandValidatorTest 
    {
        private PlaceGarmentExpenditureGoodCommandValidator GetValidationRules()
        {
            return new PlaceGarmentExpenditureGoodCommandValidator();
        }
