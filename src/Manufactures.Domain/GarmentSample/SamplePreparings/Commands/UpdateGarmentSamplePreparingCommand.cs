...
{
    public class UpdateGarmentSamplePreparingCommand : ICommand<GarmentSamplePreparing>
    {
    ...
    public class UpdateGarmentSamplePreparingCommandValidator : AbstractValidator<UpdateGarmentSamplePreparingCommand>
    {
        public UpdateGarmentSamplePreparingCommandValidator()
        {
