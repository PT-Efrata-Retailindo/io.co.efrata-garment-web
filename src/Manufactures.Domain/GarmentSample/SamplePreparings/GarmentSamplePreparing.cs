...
{
    public class GarmentSamplePreparing : AggregateRoot<GarmentSamplePreparing, GarmentSamplePreparingReadModel>
    {
        ...
        public GarmentSamplePreparing(Guid identity, int uenId, string uenNo, UnitDepartmentId unitId, string unitCode, string unitName, DateTimeOffset? processDate, string roNo, string article, bool isCuttingIn, Shared.ValueObjects.BuyerId buyerId, string buyerCode, string buyerName) : base(identity)
        {
            this.MarkTransient();
            ...
            ReadModel = new GarmentSamplePreparingReadModel(Identity)
            {
                UENId = UENId,
                UENNo = UENNo,
                UnitId = UnitId.Value,
        ...
        public GarmentSamplePreparing(GarmentSamplePreparingReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSamplePreparing GetEntity()
        {
            return this;
        }
    }
