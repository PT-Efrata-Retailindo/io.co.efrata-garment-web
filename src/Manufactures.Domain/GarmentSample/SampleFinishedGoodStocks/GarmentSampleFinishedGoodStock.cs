...
{
    public class GarmentSampleFinishedGoodStock : AggregateRoot<GarmentSampleFinishedGoodStock, GarmentSampleFinishedGoodStockReadModel>
    {
        ...
        public GarmentSampleFinishedGoodStock(Guid identity, string finishedGoodStockNo, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, GarmentComodityId comodityId, string comodityCode, string comodityName, SizeId sizeId, string sizeName, UomId uomId, string uomUnit, double quantity, double basicPrice, double price) : base(identity)
        {
            ...
            ReadModel = new GarmentSampleFinishedGoodStockReadModel(Identity)
            {
                FinishedGoodStockNo = FinishedGoodStockNo,
                RONo = RONo,
                Article = Article,
        ...
        public GarmentSampleFinishedGoodStock(GarmentSampleFinishedGoodStockReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSampleFinishedGoodStock GetEntity()
        {
            return this;
        }
    }
