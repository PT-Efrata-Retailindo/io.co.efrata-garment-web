...
namespace Manufactures.Domain.GarmentSample.SampleFinishedGoodStocks.ReadModels
{
    public class GarmentSampleFinishedGoodStockHistoryReadModel : ReadModelBase
    {
        public GarmentSampleFinishedGoodStockHistoryReadModel(Guid identity) : base(identity)
        {
        }
