...
{
    public class UpdateGarmentSampleSewingOutCommand : ICommand<GarmentSampleSewingOut>
    {
        ...
        public Manufactures.Domain.Shared.ValueObjects.GarmentComodity Comodity { get; set; }
    ...
    public class UpdateGarmentSewingOutCommandValidator : AbstractValidator<UpdateGarmentSampleSewingOutCommand>
    {
