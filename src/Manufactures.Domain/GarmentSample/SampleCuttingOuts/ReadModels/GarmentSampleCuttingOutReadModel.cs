...
{
    public class GarmentSampleCuttingOutReadModel : ReadModelBase
    {
        public GarmentSampleCuttingOutReadModel(Guid identity) : base(identity)
        {
        }
        ...
        public virtual List<GarmentSampleCuttingOutItemReadModel> GarmentSampleCuttingOutItem { get; internal set; }
    }
}
