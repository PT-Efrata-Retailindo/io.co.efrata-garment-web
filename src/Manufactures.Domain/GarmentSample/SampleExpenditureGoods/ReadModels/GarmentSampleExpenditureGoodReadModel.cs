...
{
    public class GarmentSampleExpenditureGoodReadModel : ReadModelBase
    {
        public GarmentSampleExpenditureGoodReadModel(Guid identity) : base(identity)
        {
        }
        ...
        public virtual List<GarmentSampleExpenditureGoodItemReadModel> Items { get; internal set; }
    }
}
