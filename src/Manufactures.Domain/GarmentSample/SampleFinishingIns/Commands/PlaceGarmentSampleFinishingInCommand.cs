...
{
    public class PlaceGarmentSampleFinishingInCommand : ICommand<GarmentSampleFinishingIn>
    {
        ...
        public List<GarmentSampleFinishingInItemValueObject> Items { get; set; }
    ...
    public class PlaceGarmentFinishingInCommandValidator : AbstractValidator<PlaceGarmentSampleFinishingInCommand>
    {
        public PlaceGarmentFinishingInCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentSampleFinishingInItemValueObjectValidator());
        }
    }

    class GarmentSampleFinishingInItemValueObjectValidator : AbstractValidator<GarmentSampleFinishingInItemValueObject>
    {
        public GarmentSampleFinishingInItemValueObjectValidator()
        {
