...
{
    public class GarmentSampleFinishingInItemReadModel : ReadModelBase
    {
        public GarmentSampleFinishingInItemReadModel(Guid identity) : base(identity)
        {
        ...
        public virtual GarmentSampleFinishingInReadModel GarmentSampleFinishingIn { get; internal set; }
