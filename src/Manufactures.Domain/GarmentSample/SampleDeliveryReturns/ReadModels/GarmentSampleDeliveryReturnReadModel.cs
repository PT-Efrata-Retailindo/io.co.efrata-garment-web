...
{
    public class GarmentSampleDeliveryReturnReadModel : ReadModelBase
    {
        public GarmentSampleDeliveryReturnReadModel(Guid identity) : base(identity)
        {
        ...
        public virtual List<GarmentSampleDeliveryReturnItemReadModel> GarmentSampleDeliveryReturnItem { get; internal set; }
    }
}
