...
{
    public class GarmentSampleDeliveryReturn : AggregateRoot<GarmentSampleDeliveryReturn, GarmentSampleDeliveryReturnReadModel>
    {
        ...
        public GarmentSampleDeliveryReturn(Guid identity, string drNo, string roNo, string article, int unitDOId, string unitDONo, int uenId, string preparingId, DateTimeOffset? returnDate, string returnType, UnitDepartmentId unitId, string unitCode, string unitName, StorageId storageId, string storageName, string storageCode, bool isUsed) : base(identity)
        {
            ...
            ReadModel = new GarmentSampleDeliveryReturnReadModel(identity)
            {
                DRNo = DRNo,
                RONo = RONo,
                Article = Article,
        ...
        public GarmentSampleDeliveryReturn(GarmentSampleDeliveryReturnReadModel readModel) : base(readModel)
        {
            DRNo = ReadModel.DRNo;
            RONo = ReadModel.RONo;
        ...
        protected override GarmentSampleDeliveryReturn GetEntity()
        {
            return this;
        }
    }
