...
{
    public class GarmentSampleFinishingOutReadModel : ReadModelBase
    {
        public GarmentSampleFinishingOutReadModel(Guid identity) : base(identity)
        {
        }
        ...
        public virtual List<GarmentSampleFinishingOutItemReadModel> GarmentSampleFinishingOutItem { get; internal set; }
    }
}
