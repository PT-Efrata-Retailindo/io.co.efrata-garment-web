...
{
    public class GarmentSampleFinishingOut : AggregateRoot<GarmentSampleFinishingOut, GarmentSampleFinishingOutReadModel>
    {
        ...
        public GarmentSampleFinishingOut(Guid identity, string finishingOutNo, UnitDepartmentId unitToId, string unitToCode, string unitToName, string finishingTo, DateTimeOffset finishingOutDate, string rONo, string article, UnitDepartmentId unitId, string unitCode, string unitName, GarmentComodityId comodityId, string comodityCode, string comodityName, bool isDifferentSize) : base(identity)
        {
            ...
            ReadModel = new GarmentSampleFinishingOutReadModel(Identity)
            {
                FinishingOutNo = FinishingOutNo,
                FinishingTo = FinishingTo,
        ...
        public GarmentSampleFinishingOut(GarmentSampleFinishingOutReadModel readModel) : base(readModel)
        {
        ...
        protected override GarmentSampleFinishingOut GetEntity()
        {
            return this;
        }
    }
