...
{
    public class GarmentSampleFinishingOutItemValueObject : ValueObject
    {
        ...
        public List<GarmentSampleFinishingOutDetailValueObject> Details { get; set; }
        ...
        public GarmentSampleFinishingOutItemValueObject()
        {
        }
