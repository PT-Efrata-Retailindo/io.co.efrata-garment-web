...
{
    public class PlaceGarmentSampleFinishingOutCommand : ICommand<GarmentSampleFinishingOut>
    {
        ...
        public List<GarmentSampleFinishingOutItemValueObject> Items { get; set; }
        public bool IsSave { get; set; }
        public double Price { get; set; }

    }

    public class PlaceGarmentSampleFinishingOutCommandValidator : AbstractValidator<PlaceGarmentSampleFinishingOutCommand>
    {
        public PlaceGarmentSampleFinishingOutCommandValidator()
        {
            ...
            RuleForEach(r => r.Items).SetValidator(new GarmentSampleFinishingOutItemValueObjectValidator());
        }
    }

    class GarmentSampleFinishingOutItemValueObjectValidator : AbstractValidator<GarmentSampleFinishingOutItemValueObject>
    {
        public GarmentSampleFinishingOutItemValueObjectValidator()
        {
            ...
            RuleForEach(r => r.Details).SetValidator(new GarmentSampleFinishingOutDetailValueObjectValidator()).When(r => r.IsDifferentSize == true && r.IsSave == true);

        }
    }

    class GarmentSampleFinishingOutDetailValueObjectValidator : AbstractValidator<GarmentSampleFinishingOutDetailValueObject>
    {
        public GarmentSampleFinishingOutDetailValueObjectValidator()
        {
