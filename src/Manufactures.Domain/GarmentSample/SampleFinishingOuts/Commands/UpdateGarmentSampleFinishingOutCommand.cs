...
{
    public class UpdateGarmentSampleFinishingOutCommand : ICommand<GarmentSampleFinishingOut>
    {
    ...
    public class UpdateGarmentSampleFinishingOutCommandValidator : AbstractValidator<UpdateGarmentSampleFinishingOutCommand>
    {
        public UpdateGarmentSampleFinishingOutCommandValidator()
        {
