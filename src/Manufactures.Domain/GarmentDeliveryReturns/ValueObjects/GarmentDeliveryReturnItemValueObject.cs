...
namespace Manufactures.Domain.GarmentDeliveryReturns.ValueObjects
{
    public class GarmentDeliveryReturnItemValueObject : ValueObject
    {
        ...
        public GarmentDeliveryReturnItemValueObject(Guid id, Guid drId, int unitDOItemId, int uenItemId, string preparingItemId, Product product, string designColor, string roNo, double quantity, Uom uom, Guid garmentDeliveryReturnId, double quantityUENItem, double remainingQuantityPreparingItem, bool isSave, string colour, string rack, string level, string box, string area)
        {
            Id = id;
            DRId = drId;
