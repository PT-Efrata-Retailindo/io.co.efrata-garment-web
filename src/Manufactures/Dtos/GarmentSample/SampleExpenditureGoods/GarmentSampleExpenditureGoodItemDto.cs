...
{
    public class GarmentSampleExpenditureGoodItemDto : BaseDto
    {
        public GarmentSampleExpenditureGoodItemDto(GarmentSampleExpenditureGoodItem garmentExpenditureGoodItem)
        {
