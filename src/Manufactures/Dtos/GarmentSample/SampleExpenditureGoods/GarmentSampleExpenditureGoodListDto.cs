...
{
    public class GarmentSampleExpenditureGoodListDto : BaseDto
    {
        public GarmentSampleExpenditureGoodListDto(GarmentSampleExpenditureGood garmentExpenditureGood)
        {
