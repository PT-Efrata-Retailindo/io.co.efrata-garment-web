...
namespace Manufactures.Dtos.GarmentSample.SampleFinishedGoodStocks
{
    public class GarmentSampleFinishedGoodStockDto
    {
        public GarmentSampleFinishedGoodStockDto(GarmentSampleFinishedGoodStock finishedGoodStock){
