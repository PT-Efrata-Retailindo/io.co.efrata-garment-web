...
{
    public class GarmentSampleFinishingInDto : BaseDto
    {
        public GarmentSampleFinishingInDto(GarmentSampleFinishingIn garmentFinishingIn)
        {
            ...
            Items = new List<GarmentSampleFinishingInItemDto>();
        }
        ...
        public virtual List<GarmentSampleFinishingInItemDto> Items { get; internal set; }
    }
}
