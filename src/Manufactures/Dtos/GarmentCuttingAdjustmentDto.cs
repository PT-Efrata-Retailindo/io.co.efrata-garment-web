...
{
    public class GarmentCuttingAdjustmentDto
    {
        public GarmentCuttingAdjustmentDto(GarmentCuttingAdjustment garmentCuttingAdjustment)
        {
            ...
            AdjustmentDesc = garmentCuttingAdjustment.AdjustmentDesc;

            Items = new List<GarmentCuttingAdjustmentItemDto>();
        }
        ...
        public List<GarmentCuttingAdjustmentItemDto> Items { get; set; }
    }
}
