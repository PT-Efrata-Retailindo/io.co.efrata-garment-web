...
{
    public class GarmentSampleCuttingInRepository : AggregateRepostory<GarmentSampleCuttingIn, GarmentSampleCuttingInReadModel>, IGarmentSampleCuttingInRepository
    {
        public IQueryable<GarmentSampleCuttingInReadModel> Read(int page, int size, string order, string keyword, string filter)
        {
            var data = Query;
            ...
            data = QueryHelper<GarmentSampleCuttingInReadModel>.Filter(data, FilterDictionary);
            ...
            data = OrderDictionary.Count == 0 ? data.OrderByDescending(o => o.ModifiedDate) : QueryHelper<GarmentSampleCuttingInReadModel>.Order(data, OrderDictionary);
        ...
        protected override GarmentSampleCuttingIn Map(GarmentSampleCuttingInReadModel readModel)
        {
            return new GarmentSampleCuttingIn(readModel);
        }

        public IQueryable<object> ReadExecute(IQueryable<GarmentSampleCuttingInReadModel> query)
        {
