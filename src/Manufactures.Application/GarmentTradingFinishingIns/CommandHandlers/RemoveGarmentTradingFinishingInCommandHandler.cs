...
{
    public class RemoveGarmentTradingFinishingInCommandHandler : ICommandHandler<RemoveGarmentTradingFinishingInCommand, GarmentFinishingIn>
    {
        ...
        public RemoveGarmentTradingFinishingInCommandHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<GarmentFinishingIn> Handle(RemoveGarmentTradingFinishingInCommand request, CancellationToken cancellationToken)
        {
