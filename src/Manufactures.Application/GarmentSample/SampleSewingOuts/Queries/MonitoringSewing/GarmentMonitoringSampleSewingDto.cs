...
{
    public class GarmentMonitoringSampleSewingDto
    {
        public GarmentMonitoringSampleSewingDto()
        {
        }
        ...
        public GarmentMonitoringSampleSewingDto(GarmentMonitoringSampleSewingDto garmentMonitoring)
        {
