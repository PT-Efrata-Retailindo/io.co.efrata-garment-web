...
{
    public class GarmentSubconDLORawMaterialReportListViewModel
    {
        public List<GarmentSubconDLORawMaterialReportDto> garmentSubconDLORawMaterialReportDto { get; set; }
