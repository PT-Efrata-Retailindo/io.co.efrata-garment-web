...
{
    public class TCKecil_In_QueryHandler : IQueryHandler<TCKecil_In_Query, ScrapListViewModel>
    {
        ...
        public TCKecil_In_QueryHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<ScrapListViewModel> Handle(TCKecil_In_Query request, CancellationToken cancellationToken)
        {
