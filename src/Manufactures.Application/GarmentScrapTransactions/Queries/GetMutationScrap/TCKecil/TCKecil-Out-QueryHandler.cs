...
{
    public class TCKecil_Out_QueryHandler : IQueryHandler<TCKecil_Out_Query, ScrapListViewModel>
    {
        ...
        public TCKecil_Out_QueryHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<ScrapListViewModel> Handle(TCKecil_Out_Query request, CancellationToken cancellationToken)
        {
