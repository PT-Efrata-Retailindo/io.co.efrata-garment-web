...
{
    public class Sapuan_In_QueryHandler : IQueryHandler<Sapuan_In_Query, ScrapListViewModel>
    {
        ...
        public Sapuan_In_QueryHandler(IStorage storage)
        {
            _storage = storage;
        ...
        public async Task<ScrapListViewModel> Handle(Sapuan_In_Query request, CancellationToken cancellationToken)
        {
