...
{
    public partial class addBalaneFinishingTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GarmentBalanceFinishings",
                columns: table => new
                {
                    ...
                    FinishingQty = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentBalanceFinishings", x => x.Identity);
                });
        }
