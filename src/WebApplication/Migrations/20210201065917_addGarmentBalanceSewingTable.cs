...
{
    public partial class addGarmentBalanceSewingTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "GarmentBalanceSewings",
                columns: table => new
                {
                    ...
                    SewingOutQtyPcs = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GarmentBalanceSewings", x => x.Identity);
                });
        }
